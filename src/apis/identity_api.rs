...
pub async fn batch_patch_identities(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<BatchPatchIdentitiesError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
...
pub async fn delete_identity_sessions(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<DeleteIdentitySessionsError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn extend_session(
  ...
  let id = crate::apis::urlencode(id);
  let possible_uri_len =
    local_var_configuration.base_path.len() + "/admin/sessions/".len() + id.len() + "/extend".len();
...
pub async fn list_identity_schemas(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<ListIdentitySchemasError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn list_identity_sessions(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<ListIdentitySessionsError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
