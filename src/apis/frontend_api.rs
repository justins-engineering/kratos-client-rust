...
pub async fn create_browser_login_flow(
  ...
  if let Some(ref local_var_str) = login_challenge {
    local_var_req_builder =
      local_var_req_builder.query(&[("login_challenge", &local_var_str.to_string())]);
  }
  ...
  if let Some(local_var_param_value) = cookie {
    local_var_req_builder =
      local_var_req_builder.header("Cookie", local_var_param_value.to_string());
  }
...
pub async fn create_browser_login_flow(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<CreateBrowserLoginFlowError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
...
pub async fn create_browser_registration_flow(
  ...
  if let Some(ref local_var_str) = after_verification_return_to {
    local_var_req_builder =
      local_var_req_builder.query(&[("after_verification_return_to", &local_var_str.to_string())]);
  }
  if let Some(ref local_var_str) = organization {
    local_var_req_builder =
      local_var_req_builder.query(&[("organization", &local_var_str.to_string())]);
...
pub async fn create_fedcm_flow(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<CreateFedcmFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn create_native_login_flow(
  ...
  organization: Option<&str>,
  via: Option<&str>,
) -> Result<models::LoginFlow, Error<CreateNativeLoginFlowError>> {
  let local_var_configuration = configuration;
...
#[cfg(feature = "reqwest")]
pub async fn create_native_recovery_flow(
  configuration: &configuration::Configuration,
) -> Result<models::RecoveryFlow, Error<CreateNativeRecoveryFlowError>> {
  let local_var_configuration = configuration;
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<CreateNativeRecoveryFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
#[cfg(feature = "reqwest")]
pub async fn create_native_registration_flow(
  configuration: &configuration::Configuration,
  return_session_token_exchange_code: Option<bool>,
  return_to: Option<&str>,
  organization: Option<&str>,
) -> Result<models::RegistrationFlow, Error<CreateNativeRegistrationFlowError>> {
  let local_var_configuration = configuration;
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<CreateNativeRegistrationFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn create_native_settings_flow(
  configuration: &configuration::Configuration,
  x_session_token: Option<&str>,
) -> Result<models::SettingsFlow, Error<CreateNativeSettingsFlowError>> {
  let local_var_configuration = configuration;
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<CreateNativeSettingsFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
#[cfg(feature = "reqwest")]
pub async fn create_native_verification_flow(
  configuration: &configuration::Configuration,
  return_to: Option<&str>,
) -> Result<models::VerificationFlow, Error<CreateNativeVerificationFlowError>> {
  let local_var_configuration = configuration;
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<CreateNativeVerificationFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn disable_my_other_sessions(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<DisableMyOtherSessionsError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn disable_my_session(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<DisableMySessionError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn exchange_session_token(
  ...
  local_var_req_builder =
    local_var_req_builder.query(&[("return_to_code", &return_to_code.to_string())]);
  if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
    local_var_req_builder =
      local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
  }
...
pub async fn exchange_session_token(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<ExchangeSessionTokenError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn get_flow_error(
  ...
  let local_var_uri_str = format!("{}/self-service/errors", local_var_configuration.base_path);
  let mut local_var_req_builder =
    local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_recovery_flow(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<GetRecoveryFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn get_registration_flow(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<GetRegistrationFlowError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn get_settings_flow(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<GetSettingsFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn get_verification_flow(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<GetVerificationFlowError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn get_web_authn_java_script(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<GetWebAuthnJavaScriptError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn list_my_sessions(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<ListMySessionsError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
#[cfg(feature = "reqwest")]
pub async fn perform_native_logout(
  configuration: &configuration::Configuration,
  perform_native_logout_body: models::PerformNativeLogoutBody,
) -> Result<(), Error<PerformNativeLogoutError>> {
  let local_var_configuration = configuration;
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<PerformNativeLogoutError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn to_session(
  ...
  let local_var_uri_str = format!("{}/sessions/whoami", local_var_configuration.base_path);
  let mut local_var_req_builder =
    local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

  if let Some(ref local_var_str) = tokenize_as {
    local_var_req_builder =
      local_var_req_builder.query(&[("tokenize_as", &local_var_str.to_string())]);
  }
  if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
    local_var_req_builder =
      local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn update_fedcm_flow(
  ...
  local_var_req_builder = local_var_req_builder.json(&update_fedcm_flow_body);
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<UpdateFedcmFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn update_login_flow(
  ...
  let local_var_uri_str = format!("{}/self-service/login", local_var_configuration.base_path);
  let mut local_var_req_builder =
    local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<UpdateLoginFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn update_logout_flow(
  ...
  let local_var_uri_str = format!("{}/self-service/logout", local_var_configuration.base_path);
  let mut local_var_req_builder =
    local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<UpdateLogoutFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn update_recovery_flow(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<UpdateRecoveryFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn update_registration_flow(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<UpdateRegistrationFlowError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
...
pub async fn update_settings_flow(
  ...
  if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
    ...
    let local_var_entity: Option<UpdateSettingsFlowError> =
      serde_json::from_str(&local_var_content).ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: local_var_content,
...
pub async fn update_verification_flow(
  ...
  if !(400..600).contains(&local_var_status) {
    ...
    let local_var_entity: Option<UpdateVerificationFlowError> = local_var_content.into_serde().ok();
    let local_var_error = ResponseContent {
      status: local_var_status,
      content: if local_var_content.is_undefined() {
        String::from("null")
