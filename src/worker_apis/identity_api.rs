...
pub async fn batch_patch_identities(
    ...
    req_builder.with_method(worker::Method::Patch);
...
pub async fn delete_identity_credentials(
    ...
    let id = crate::worker_apis::urlencode(id);
    let r#type = crate::worker_apis::urlencode(r#type);
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/admin/identities/");
    uri_str.push_str(&id);
...
pub async fn get_identity_by_external_id(
    ...
    let external_id = crate::worker_apis::urlencode(external_id);
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
...
pub async fn update_identity(
    ...
    headers.append("Content-Type", "application/json")?;
    let mut req_builder = worker::RequestInit::new();
    req_builder.with_method(worker::Method::Put);
    req_builder.with_headers(headers);
