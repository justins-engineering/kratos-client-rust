...
pub async fn create_browser_login_flow(
    ...
    if let Some(ref str) = aal {
        uri_str.add_query(&mut is_first_query, "aal=", &str.to_string());
    }
    ...
    if let Some(ref str) = login_challenge {
        uri_str.add_query(&mut is_first_query, "login_challenge=", &str.to_string());
    }
    if let Some(ref str) = organization {
        uri_str.add_query(&mut is_first_query, "organization=", &str.to_string());
    }
    if let Some(ref str) = via {
        uri_str.add_query(&mut is_first_query, "via=", &str.to_string());
    }
    if let Some(ref str) = identity_schema {
        uri_str.add_query(&mut is_first_query, "identity_schema=", &str.to_string());
    }
...
pub async fn create_native_login_flow(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/login/api");
    let mut is_first_query: bool = true;
    if let Some(ref str) = refresh {
        uri_str.add_query(&mut is_first_query, "refresh=", &str.to_string());
    }
    ...
    if let Some(ref str) = return_session_token_exchange_code {
        uri_str.add_query(
            &mut is_first_query,
...
pub async fn create_native_recovery_flow(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/recovery/api");
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
    }
...
pub async fn create_native_registration_flow(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/registration/api");
    let mut is_first_query: bool = true;
    if let Some(ref str) = return_session_token_exchange_code {
        uri_str.add_query(
            &mut is_first_query,
...
pub async fn create_native_settings_flow(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/settings/api");
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
    }
...
pub async fn create_native_verification_flow(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/verification/api");
    let mut is_first_query: bool = true;
    if let Some(ref str) = return_to {
        uri_str.add_query(&mut is_first_query, "return_to=", &str.to_string());
    }
...
pub async fn disable_my_other_sessions(
    ...
    headers.append("Accept", "application/json")?;
    let mut req_builder = worker::RequestInit::new();
    req_builder.with_method(worker::Method::Delete);
    req_builder.with_headers(headers);
    let req = worker::Request::new_with_init(&uri_str, &req_builder)?;
    let resp = worker::Fetch::Request(req).send().await?;
    super::handle_response(resp).await
...
pub async fn exchange_session_token(
    ...
    let mut is_first_query: bool = true;
    uri_str.add_query(&mut is_first_query, "init_code=", &init_code.to_string());
    uri_str.add_query(
        &mut is_first_query,
        "return_to_code=",
        &return_to_code.to_string(),
    );
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
...
pub async fn get_flow_error(
    ...
    let mut is_first_query: bool = true;
    uri_str.add_query(&mut is_first_query, "id=", &id.to_string());
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
    }
...
pub async fn perform_native_logout(
    ...
    let mut uri_str = String::new();
    uri_str.push_str(&configuration.base_path);
    uri_str.push_str("/self-service/logout/api");
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
    }
    ...
    req_builder.with_method(worker::Method::Delete);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&perform_native_logout_body)?));
    let req = worker::Request::new_with_init(&uri_str, &req_builder)?;
    let resp = worker::Fetch::Request(req).send().await?;
    super::handle_empty_response(resp).await
}
...
pub async fn to_session(
    ...
    if let Some(ref str) = tokenize_as {
        uri_str.add_query(&mut is_first_query, "tokenize_as=", &str.to_string());
    }
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
...
pub async fn update_fedcm_flow(
    ...
    headers.append("Content-Type", "application/json")?;
    let mut req_builder = worker::RequestInit::new();
    req_builder.with_method(worker::Method::Post);
    req_builder.with_headers(headers);
...
pub async fn update_login_flow(
    ...
    let mut is_first_query: bool = true;
    uri_str.add_query(&mut is_first_query, "flow=", &flow.to_string());
    let headers = worker::Headers::new();
    if let Some(ref user_agent) = configuration.user_agent {
        headers.append("USER_AGENT", user_agent)?;
    }
...
pub async fn update_logout_flow(
    ...
    if let Some(ref str) = token {
        uri_str.add_query(&mut is_first_query, "token=", &str.to_string());
    }
    if let Some(ref str) = return_to {
        uri_str.add_query(&mut is_first_query, "return_to=", &str.to_string());
    }
