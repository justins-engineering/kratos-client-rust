...
pub async fn create_browser_registration_flow(
    ...
    if !(400..600).contains(&status) {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateBrowserRegistrationFlowError> =
...
pub async fn create_browser_verification_flow(
    ...
    if !(400..600).contains(&status) {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateBrowserVerificationFlowError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content: if content.is_empty() {
...
pub async fn get_login_flow(
    ...
    let status: u16 = resp.status_code();
    let content_type = super::ContentType::from(&resp);
...
pub async fn update_fedcm_flow(
    ...
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_fedcm_flow_body)?));
...
pub async fn update_login_flow(
    ...
    req_builder.with_method(Method::Post);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_login_flow_body)?));
...
pub async fn update_recovery_flow(
    ...
    req_builder.with_method(Method::Post);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_recovery_flow_body)?));
...
pub async fn update_registration_flow(
    ...
    req_builder.with_method(Method::Post);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_registration_flow_body)?));
...
pub async fn update_settings_flow(
    ...
    req_builder.with_method(Method::Post);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_settings_flow_body)?));
...
pub async fn update_verification_flow(
    ...
    req_builder.with_method(Method::Post);
    req_builder.with_headers(headers);
    req_builder.with_body(Some(JsValue::from_serde(&update_verification_flow_body)?));
